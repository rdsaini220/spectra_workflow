...
const WorkflowPage = () => {
  ...
  const handelLayoutPreView = (item, ind) => {
    const isCheck = activeLayout >= 0
    if(cards.length > 0 && activeLayout === null){
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-5 text-end">
                   <div className='d-flex justify-content-end'>
                        ...
                        {
                          activeLayout !== null ? 
                            <button onClick={() => handleClear()} className="btn btn-danger btn-sm" title="clear">
                      ...
                      </div>                      
                       {
                          activeLayout !== null ? 
                            <div className="col-lg-2 d-flex justify-content-end">
                                ...
                                className="btn btn-primary icon-btn" title={previewMode ? 'Edit Mode' : 'Preview Mode'}>
            ...
            <div className="col-lg-4 mx-auto">
                {
                  !previewMode ?
                    cards?.length !== 0 && activeCard !== null ?
                      <>
                        <form onSubmit={handleSubmit} className='shadow p-3 mb-4 bg-body-tertiary rounded w-100'>
                            <div class="mb-3">
                  ...
                  : previewMode && priView !== null && priView !== '' ? 
                      <>
                        <div className='shadow p-3 mb-4 bg-body-tertiary rounded w-100'>
